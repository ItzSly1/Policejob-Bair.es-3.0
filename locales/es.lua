Locales['es'] = {
  ...
  ['open_teleports'] = 'Presionar ~INPUT_CONTEXT~ para abrir el menu de Teleport',
  ['open_chaleco'] = 'Presionar ~INPUT_CONTEXT~ para abrir el menu de chalecos',
  ['open_accesorios'] = 'Presionar ~INPUT_CONTEXT~ para abrir el menu de accesorios',
  ['open_vehiculos'] = 'Presionar ~INPUT_CONTEXT~ para abrir el garage',
  -- Armory
  ['remove_object'] = 'Agarrar objeto',
  ['deposit_object'] = 'Depositar objeto',
  ['get_weapon'] = 'Agarrar arma',
  ['put_weapon'] = 'Depositar arma',
  ['buy_weapons'] = 'Comprar armas',
  ['armory'] = 'Armeria - Policial',
  ...
  ['fine'] = 'Multa',
  ['unpaid_bills'] = 'Gestionar multas impagas',
  ...
  -- Traffic interaction
  ['traffic_interaction'] = 'Menú de objetos',
  ['cone'] = '<i class="fas fa-traffic-cone"></i> Cono',
  ['spikestrips'] = '<i class="fas fa-lightbulb-on"></i> Cono con led',
  ['barrier'] = '<i class="fas fa-container-storage"></i> Barrera',
  ['cash'] = '<i class="fas fa-traffic-cone"></i> Desvio de carril',
  ['box'] = '<i class="fas fa-tools"></i> Pinchos',
  -- ID Card Menu
  ['name'] = 'Nombre: %s',
  ['sex'] = 'Sexo: %s',
